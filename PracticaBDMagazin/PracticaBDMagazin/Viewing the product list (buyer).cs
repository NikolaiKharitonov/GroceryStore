...
{
    public partial class Viewing_the_product_list__buyer_ : Form
    {
        public Viewing_the_product_list__buyer_()
        {
            InitializeComponent();
        }
        ...
        private void Viewing_the_product_list__buyer__Load(object sender, EventArgs e)
        {
